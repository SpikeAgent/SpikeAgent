...
from tool.utils.custom_class_gemini import ChatGoogleGenerativeAI_H
...
import pathlib
doc_path = pathlib.Path(__file__).parent.parent / "spikeinterface_api_docs" / "merged_api.txt"
